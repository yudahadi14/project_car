<?php
    ...
    if (count($serviceDtaData) == 0) {
        redirect(base_url().'services/completed_services', 'refresh');
    }
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Completed Service for Job Id #<?php echo $job_id; ?></h1>
		</div>
	</div><!--/.row-->
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">				
				<div class="panel-heading">
					<table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
						<tr>
							<td width="50%">
								Completed Service for : Job Id #<?php echo $job_id; ?>
							</td>
				...
				<div class="panel-body" style="padding: 10px 15px 15px 15px;">
					...
					<?php
                        $reqDefectResult    = $this->db->query("SELECT * FROM service_job_defects_material WHERE service_job_id = '$job_id' AND customer_approved = '1' AND status = '1' ORDER BY id DESC ");
                            ...
                            for ($rd = 0; $rd < count($reqDefectData); $rd++) {
                                ...
                                $defect_remarks    = $defectDtaData[0]->remarks; ?>
														<tr>
															...
															<td>
																<?php echo $reqDefect_issued_qty; ?>
															</td>
															<td>
																<?php echo number_format($reqDefect_issued_price, 2); ?>
															</td>
															<td style="font-weight: bold;">
																<?php
                                                                    if ($reqDefect_status == "1") {
                                                                        echo "<span style='color: #059405;'>Issued</span>";
                                                                    } elseif ($reqDefect_status == "0") {
                                                                        if ($reqDefect_cust_approved == "2") {
                                                                            echo "<span style='color: #c72a25;'>Rejected By Customer</span>";
                                                                        } else {
                                                                            echo "-";
                                                                        }
                                                                    } ?>
					...
					<?php
                        $reqpackageResult    = $this->db->query("SELECT * FROM service_job_package_material WHERE service_job_id = '$job_id' AND request_approved = '1' AND status = '1' ORDER BY id DESC ");
                        $reqpackageRows    = $reqpackageResult->num_rows();
                        if ($reqpackageRows > 0) {
                            ?>
					<div class="row" style="border-bottom: 1px solid #ddd; padding-bottom: 5px; padding-top: 15px;">
	                    <div class="col-md-12">
							<div class="row">
			                    <div class="col-md-12">
                            ...
                            for ($rp = 0; $rp < count($reqpackageData); $rp++) {
                                ...
                                $task_name                = $taskNameData[0]->name; ?>
													<tr>
														...
														<td>
															<?php echo $reqpackage_issued_qty; ?>
														</td>
														<td style="font-weight: bold;">
															<?php
					...
					<?php
                        if ($service_status_id == "5") {
                            ?>
					<div class="row" style="padding-top: 20px; padding-bottom: 20px;">
						<div class="col-md-12" style="text-align: center;">
							<a href="<?=base_url()?>services/generateInvoice?job_id=<?php echo $job_id; ?>" style="text-decoration: none;">
	...
	<a href="<?=base_url()?>services/completed_services" style="text-decoration: none;">
