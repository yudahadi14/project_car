<?php
    ...
    if (count($serviceDtaData) == 0) {
        redirect(base_url().'technician_services/tech_completed_services', 'refresh');
    }
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Completed Service : Job Id #<?php echo $job_id; ?></h1>
		</div>
	</div><!--/.row-->
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">				
				<div class="panel-heading">
					<table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
						<tr>
							<td width="50%">
								Completed Service : Job Id #<?php echo $job_id; ?>
							</td>
	...
	<a href="<?=base_url()?>technician_services/tech_completed_services" style="text-decoration: none;">
