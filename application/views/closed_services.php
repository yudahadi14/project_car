...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Closed Services</h1>
		</div>
	</div><!--/.row-->
						...
						<?php
                            if (count($results) > 0) {
                                foreach ($results as $data) {
                                    ...
                                    $car_id        = $data->car_id;
                                    $invoice_numb    = $data->invoice_number;
                                    $grandTotal    = $data->grandtotal_amt;
									...
									<tr>
										...
										<td style="padding: 7px 7px; border-bottom: 1px solid #ddd; letter-spacing: 0.3px;"><?php echo $invoice_numb; ?></td>
