...
class PHPExcel_Writer_Excel5_Escher
{
    ...
    public function close()
    {
        ...
        case 'PHPExcel_Shared_Escher_DggContainer':
            ...
            // dgg data
            $dggData =
                pack('VVVV', $this->_object->getSpIdMax() // maximum shape identifier increased by one, $this->_object->getCDgSaved() + 1 // number of file identifier clusters increased by one, $this->_object->getCSpSaved(), $this->_object->getCDgSaved() // count total number of drawings saved
                );
