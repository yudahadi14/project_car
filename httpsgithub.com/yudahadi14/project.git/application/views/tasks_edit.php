<?php
    ...
    $taskData    = $this->Constant_model->getDataOneColumn("tasks", "id", $id);
    
    if (count($taskData) == 0) {
        redirect(base_url().'packages/task_lists', 'refresh');
    }
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Edit Service Task</h1>
		</div>
	</div><!--/.row-->
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body" style="padding: 25px;">
					...
					<form class="form-horizontal" action="<?=base_url()?>packages/updateTask" method="post" onsubmit="kk()">
						<fieldset>
