<?php
    ...
    if (count($serviceDtaData) == 0) {
        redirect(base_url().'technician_services/tech_requested_inventory_services', 'refresh');
    }
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Requested Inventory Service for : Job Id #<?php echo $job_id; ?></h1>
		</div>
	</div><!--/.row-->
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">				
				<div class="panel-heading">
					<table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
						<tr>
							<td width="50%">
								Requested Inventory Service for : Job Id #<?php echo $job_id; ?>
							</td>
					                    ...
					                    <table class="table">
											<tbody>
												<tr>
													...
													<td style="font-weight: bold; border-top: 0px; padding: 5px;" width="30%">Request Materials</td>
													<td style="font-weight: bold; border-top: 0px; padding: 5px;" width="20%">Request Quantity</td>
													<td style="font-weight: bold; border-top: 0px; padding: 5px;" width="20%">Status</td>
												</tr>
												<?php
                                ...
                                $defect_remarks    = $defectDtaData[0]->remarks; ?>
														<tr>
															...
															<td style="font-weight: bold;">
																<?php
                                                                    if ($reqDefect_status == "0") {
                                                                        echo "Waiting for Issued";
                                                                    } elseif ($reqDefect_status == "1") {
                                                                        echo "Issued";
                                                                    } ?>
															</td>
														</tr>
			                    ...
			                    <div class="col-md-12">
				                    <div class="table-responsive">
					                    <table class="table">
											<tbody>
												<tr>
													<td style="font-weight: bold; border-top: 0px; padding: 5px;" width="25%">Task Name</td>
													<td style="font-weight: bold; border-top: 0px; padding: 5px;" width="30%">Request Materials</td>
													<td style="font-weight: bold; border-top: 0px; padding: 5px;" width="20%">Request Quantity</td>
													<td style="font-weight: bold; border-top: 0px; padding: 5px;" width="20%">Status</td>
												</tr>
                            ...
                            for ($rp = 0; $rp < count($reqpackageData); $rp++) {
                                ...
                                $task_name            = $taskNameData[0]->name; ?>
													<tr>
														...
														<td style="font-weight: bold;">
															<?php
                                                                if ($reqpackage_status == "0") {
                                                                    echo "Waiting for issue";
                                                                } elseif ($reqpackage_status == "1") {
                                                                    echo "Issued";
                                                                } ?>
														</td>
													</tr>
	...
	<a href="<?=base_url()?>technician_services/tech_requested_inventory_services" style="text-decoration: none;">
