...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Drew Out Inventory Services</h1>
		</div>
	</div><!--/.row-->
                            ...
                            if (count($results) > 0) {
                                foreach ($results as $data) {
									...
									<tr>
										...
										<td style="padding: 7px 7px; border-bottom: 1px solid #ddd; letter-spacing: 0.3px;">
											<a href="<?=base_url()?>technician_services/tech_drew_out_inventory_services_view?job_id=<?php echo $job_id; ?>" style="text-decoration: none;">
