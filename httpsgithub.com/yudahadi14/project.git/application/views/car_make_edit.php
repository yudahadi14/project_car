<?php
    ...
    $carMakeData    = $this->Constant_model->getDataOneColumn("car_make", "id", $id);
    
    if (count($carMakeData) == 0) {
        redirect(base_url().'setting/car_make', 'refresh');
    }
    
    $name            = $carMakeData[0]->name;
    $type            = $carMakeData[0]->type;
    $status        = $carMakeData[0]->status;
?>
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body" style="padding: 25px;">
					...
					<form class="form-horizontal" action="<?=base_url()?>setting/updateCarMake" method="post" onsubmit="kk()">
						<fieldset>
