		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body" style="padding: 25px;">
					...
					<form class="form-horizontal" action="<?=base_url()?>setting/insertNewSupplier" method="post" onsubmit="kk()">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<input type="text" name="tel" class="form-control" required autocomplete="off" />
								</div>
								<div class="col-md-3"></div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<input type="text" name="tax" class="form-control" required autocomplete="off" placeholder="0.00" />
								</div>
								<div class="col-md-3"></div>
							</div>
