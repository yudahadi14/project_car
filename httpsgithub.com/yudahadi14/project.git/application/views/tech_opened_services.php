					...
					<table id="example" class="display" cellspacing="0" width="100%">
					    <thead>
					        <tr>
						    	...
						    	<th width="8%" style="padding: 7px 7px; border-bottom: 1px solid #111; letter-spacing: 0.3px;">Plate No.</th>
						    	...
						    	<th width="10%" style="padding: 7px 7px; border-bottom: 1px solid #111; letter-spacing: 0.3px;">Action</th>
					        </tr>
					    </thead>
						<tbody>
						<?php
									...
									<tr>
										...
										<td style="padding: 7px 7px; border-bottom: 1px solid #ddd; letter-spacing: 0.3px;">
											<?php
                                                if ($status_id == "1") {
                                                    ?>
												<form action="<?=base_url()?>technician_services/startJob" method="post" onsubmit="return confirm('Are you confirm to Start this Job : <?php echo $job_id; ?>?')">
											...
											<?php
                                                    ...
                                                    ?>
													<a href="<?=base_url()?>technician_services/tech_opened_services_view?job_id=<?php echo $job_id; ?>" style="text-decoration: none;">
														<div class="btn btn-primary">&nbsp;&nbsp;Req. Inventory&nbsp;&nbsp;</div>
													</a>	
											<?php
