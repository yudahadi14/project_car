...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Add New Customer Group</h1>
		</div>
	</div><!--/.row-->
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body" style="padding: 25px;">
					...
					<form class="form-horizontal" action="<?=base_url()?>setting/insertCustomerGroup" method="post" onsubmit="kk()">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<input type="text" class="form-control" name="percentage" required style="width: 100%;" autofocus autocomplete="off" placeholder="00" />
								</div>
								<div class="col-md-3"></div>
							</div>
